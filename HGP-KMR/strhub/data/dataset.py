...
class PairedDataset(Dataset):
    def __init__(self, dataset1, dataset2):
        assert len(dataset1) == len(dataset2), "两个模态样本数必须一致"
...
def build_tree_dataset(root: Union[PurePath, str], *args, **kwargs):
    ...
    event_datasets, rgb_datasets = [datasets[0]], [datasets[1]]
 
    return PairedDataset(ConcatDataset(event_datasets), ConcatDataset(rgb_datasets))
